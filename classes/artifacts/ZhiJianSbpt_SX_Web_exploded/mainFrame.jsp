...
<div id="layout1" class="nui-layout" style="width:100%;height:100%;">
    <div class="header" region="north" height="122" showSplit="false" showHeader="false">
        <div class="main_top">
            <div class="main_banner">
                <div class="main_tool">
                    <a href=""><img src="<%=basePath %>style/images/mainFrame/kj_menu.png" width="22" height="22"/>快捷</a>
                    <a href="mainFrame.jsp"><img src="<%=basePath %>style/images/mainFrame/sy_menu.png" width="22" height="22"/>首页</a>
                    <a href="javascript:void(0);"><img src="<%=basePath %>style/images/mainFrame/xx_menu.png" width="22" height="22"/>消息</a>
                    <a href="javascript:onLogOffClick();"><img src="<%=basePath %>style/images/mainFrame/zx_menu.png" width="22" height="22"/>注销</a>
                    <a href="javascript:onCloseClick();"><img src="<%=basePath %>style/images/mainFrame/tc_menu.png" width="22" height="22"/>关闭</a>
                </div>
            </div>
            <div class="main_user">
    ...
    <div title="south" region="south" showSplit="false" showHeader="false" height="30">
        <div style="line-height:28px;text-align:center;cursor:default">Copyright © 版权所有:陕西省市场监督管理局 技术支持:北京永杰友信科技有限公司</div>
    </div>
    <div title="center" region="center" style="border:0;" bodyStyle="overflow:hidden;">
        ...
        <div class="nui-splitter" style="width:100%;height:100%;" borderStyle="border:0;">
            <div size="15%" maxSize="250" minSize="100" showCollapseButton="true" style="border:0;">
                <!--OutlookTree-->
                <div id="leftTree" class="nui-outlooktree" url="<%=basePath%>mainFrame_getMenus.action" onnodeclick="onNodeSelect"
