                ...
                <div class="ZC_top">
                    ...
                    <table border="0px;">
                        <tr>
                            ...
                            <td>
                                <input id="username" style="width: 260px;text-align:left" name="userName" class="nui-textbox" required="true"
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="confirmpwd" style="width: 260px" name="password2" class="nui-password" required="true"
                        ...
                        <tr>
                            ...
                            <td style="widht:400px; margin-left:5px;">
                                <input id="veryCode" name="veryCode" onblur="isRightCode" requiredErrorText="验证码不能为空" class="nui-textbox"
                                       onenter="onKeyEnter" required="true" style="width:120px; margin-left:5px; float:left; display:inline-block;"/>

                                <img id="imgObj" alt="一张图片" src="<%=basePath%>VerifyCodeServlet" style="margin-top:3px;display:inline-block;"/>
                ...
                <div class="ZC_top">
                    ...
                    <table border="0px;">
                        <tr style="display:none;">
                            ...
                            <td>
                                <label><input id="enterprise" name="flag" checked="checked" type="radio" disabled value="0"
                                              style="width:14px; height:14px;margin-left:10px;margin-right:0px !important;"/> 企业 </label>
                                <label><input id="personal" name="flag" type="radio" value="1" disabled
                                              style="width:14px; height:14px;margin-left:20px;margin-right:0px !important;"/> 个人 </label>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="zzjg2" name="zzjgdm" style="width: 260px" onvalidation="checkValue" class="nui-textbox"/>
                            </td>
                            <td>
                ...
                <div class="ZC_top">
                    ...
                    <table border="0px;">
                        <tr id="eIsDlfr">
                            ...
                            <td colspan="2">
                                <label><input id="enterprise1" name="isDlf" type="radio"  value="0"
                                              style="width:14px; height:14px;margin-left:10px;margin-right:0px !important;"/> 独立法人 </label>
                                <label><input id="personal1" name="isDlf" checked="checked"  type="radio" value="1"
                                              style="width:14px; height:14px;margin-left:20px;margin-right:0px !important;"/> 非独立法人 </label>
                            </td>
                        </tr>
                        <tr>
                            <td><span>企业名称<span style="color:red;">*</span></span></td>
                            <td><input id="qymc" name="qymc" style="width: 260px" class="nui-textbox" required="true" onvalidation="checkqymc"/></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="lxdh" name="lxdh" style="width: 260px" class="nui-textbox" onvalidation="onPhoneOnvalidation"
                                       required="true"/>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="areaId" style="width: 255px;text-align:right" class="nui-buttonedit" onbuttonclick="onButtonEdit"
                                       required="true"/>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input name="email" style="width: 260px" class="nui-textbox" vtype="email" required="true"/></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input name="yzbm" style="width: 260px" class="nui-textbox" required="true" onvalidation="onYZBMValidation"/></td>
                            <td>
