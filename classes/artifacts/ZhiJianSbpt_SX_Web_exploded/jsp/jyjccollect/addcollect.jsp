            ...
            <fieldset style="border: solid 1px #aaa; padding: 3px; width:90%;">
                <table>
                    ...
                    <tr height="40px">
                        ...
                        <td>
                            <input id="zylylbIds" name="zylylbIds" emptyText="请选择专业领域类别" class="nui-buttonedit" width="187px" onbuttonclick="onButtonSclbEdit" required="true"/>
                        </td>
                        <td align="right">行政区域：<span style="color:red;">*</span></td>
                        <td>
                            <input id="qyIds" name="qyIds" emptyText="请选择行政区域" class="nui-buttonedit" width="220px" onbuttonclick="onButtonXzqyEdit" required="true"/>
                        </td>
                    </tr>
                    <tr>
            ...
            <fieldset style="border: solid 1px #aaa; padding: 3px; width:90%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input id="ssfrdz" onvalidation="onvalidationLegalunitName" name="SSFRDZ" class="nui-textbox" width="495px"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">负责人：</td>
                        <td>
                            <input id="lxr" name="LXR" onvalidation="onvalidationLegalunitName" class="nui-textbox" width="180px"/>
                        </td>
                        <td align="right">职务：</td>
                        <td>
            ...
            <fieldset style="border: solid 1px #aaa; padding: 3px; width:90%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input id="zgbmdz" name="ZGBMDZ" class="nui-textbox" width="495px" onvalidation="onvalidationCompetentunitName"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="right">负责人：</td>
                        <td>
                            <input id="zgbmlxr" name="ZGBMLXR" class="nui-textbox" width="180px" onvalidation="onvalidationCompetentunitName"/>
                        </td>
                        <td align="right">职务：</td>
                        <td>
                            <input id="zgbmzw" name="ZGBMZW" class="nui-textbox" width="180px" onvalidation="onvalidationCompetentunitName"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">电话：</td>
                        <td>
                            <input id="zgbmdh" name="ZGBMDH" class="nui-textbox" width="180px" id="competentphone" onvalidation="onPhoneValidation" onvalidation="onvalidationCompetentunitName"/>
                        </td>
                    </tr>
                </table>
            </fieldset>
