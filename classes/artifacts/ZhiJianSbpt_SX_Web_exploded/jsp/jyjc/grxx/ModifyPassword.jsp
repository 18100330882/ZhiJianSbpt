        ...
        <div>
            ...
            <table id="reg_table">
                <tr>
                    ...
                    <td>
                        <input id="pwd" style="width: 260px;" name="password" class="nui-password" required="true" onvalidation="checkOldPsd"/>&nbsp;&nbsp;&nbsp;<span
                ...
                <tr>
                    ...
                    <td>
                        <input id="confirmpwd3" style="width: 260px" name="password3" class="nui-password" required="true"
                               onvalidation="onRepeatPwdOnvalidation"/>&nbsp;&nbsp;&nbsp;<span id="newPassTwo" class="reg_tips">请重复上面输入的密码。</span>
                    </td>
                </tr>
                <tr>
                    <td class="btxt"><span class="red">*</span>验证码：</td>
                    <td>
                        <input id="veryCode" name="veryCode" onblur="isRightCode" requiredErrorText="验证码不能为空" class="nui-textbox" onenter="onKeyEnter"
