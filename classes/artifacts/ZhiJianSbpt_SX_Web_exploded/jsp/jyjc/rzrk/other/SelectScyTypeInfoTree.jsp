...
<div style="height:600px;">
    <div class="nui-fit">
        <ul id="tree1" class="nui-tree" style="width:100%;" showCheckBox="true"
            expandOnLoad=0 sortField="PAIXU" showTreeIcon="true" textField="NAME" idField="ID" parentField="PARENTID" resultAsTree="false">
        </ul>
    </div>
...
<script type="text/javascript">
    ...
    function GetData() {
        ...
        if (checkedNodes == null || checkedNodes == "" || checkedNodes.length == 0) {
            return "";
        }
        var result = {};
        var names = [];
