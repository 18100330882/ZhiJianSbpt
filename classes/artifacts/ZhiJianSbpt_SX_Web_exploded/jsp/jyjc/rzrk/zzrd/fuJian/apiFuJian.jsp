...
<body>
<div align="center">
    <div id="treegrid1" class="nui-treegrid" style="width:90%;height:90%;" showTreeIcon="true" treeColumn="name" idField="ID" parentField="PARENTID" resultAsTree="false" ondrawcell="onDrawCell"
