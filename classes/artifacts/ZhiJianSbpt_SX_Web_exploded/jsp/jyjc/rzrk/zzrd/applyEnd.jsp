...
<form id="form" method="post" checkType="blur">
    ...
    <div id="dataGrid" class="nui-datagrid" style="height: 200px" allowResize="false" idField="ID" multiSelect="false" showPager="false" pageSize="15" allowAlternating="true">
