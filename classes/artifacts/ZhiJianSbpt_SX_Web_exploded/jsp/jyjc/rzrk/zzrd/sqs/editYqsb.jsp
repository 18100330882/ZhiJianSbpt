...
<div id="dataGrid" class="nui-treegrid" showTreeIcon="true"
    ...
    <div property="columns">
        ...
        <div name="SORTINGNUMBER" id="sortingNumber" field="SORTINGNUMBER" width="50px" align="center" headerAlign="center">序号[产品/项目/参数]
        ...
        <div name="YQSBYXRQ" field="YQSBYXRQ" width="80px" renderer="yxrqRenderer" align="center" headerAlign="center">有效日期
