...
<form id="form1" target="id_iframe" style="padding-top:5px;margin:0 auto; width:840px; border:1px;">
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td>
                <input id="sortingNumber" name="sortingNumber" class="nui-textbox" width="500px" EmptyText="例：1.1、1.2..."/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left">说明：</td>
            <td>
                <input id="instructions" name="instructions" class="nui-textbox" width="500px" EmptyText="依据的标准（方法）名称及编号（含年号）"/>
            </td>
        </tr>
    </table>
    <div>
