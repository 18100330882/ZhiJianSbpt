    ...
    <fieldset style="border: solid 1px #aaa; padding: 3px; width:95%;">
        <div style="width:100%;">
                <table style="width: 100%">
                    <tr>
                        <td align="right" style="width: 40%">序号：<span style="color:red;">*</span></td>
                        <td>
                            <input id="sortNum" name="sortNum" class="nui-textbox" style="width:50%" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="">类别(产品/项目/参数)：<span style="color:red;">*</span></td>
                        <td>
                            <input id="category" name="category" class="nui-textbox" style="width:90%" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="">序号(产品/项目/参数)：<span style="color:red;">*</span></td>
                        <td>
                            <input id="productSortNum" name="productSortNum" class="nui-textbox" style="width:50%" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="">名称（产品/项目/参数）：<span style="color:red;">*</span></td>
                        <td>
                            <input id="productName" name="productName" class="nui-textbox" style="width:90%" allowInput="true" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="">依据的标准（方法）名称及编号（含年号）：<span style="color:red;">*</span></td>
                        <td>
                            <input id="standardNameAndNum" name="standardNameAndNum" class="nui-textarea" style="width: 90%;height: 100%" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="">所在实验场所：<span style="color:red;">*</span></td>
                        <td>
                            <input id="laboratoryPlace" name="laboratoryPlace" class="nui-textbox" style="width: 90%" allowInput="true" required="true"/>
                        </td>
                    </tr>
                </table>
        ...
        <div>
            <a id="saveGk" class="nui-button" iconCls="icon-save" onclick="save()" style="margin-left: 45%;">保存</a>
        </div>
    </fieldset>
</form>
