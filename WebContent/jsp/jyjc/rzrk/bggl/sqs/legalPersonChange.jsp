        ...
        <div style="width:100%;">
            <table style="margin-left: 20%">
                <tr>
                    ...
                    <td colspan="2">
                        <input style="width: 100%" id="applyDate" name="applyDate" class="nui-datepicker"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="natureChange" name="natureChange" class="nui-textbox" style="width: 100%"
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input id="natureOld" name="natureOld" class="nui-textbox" style="width: 100%" allowInput="true"
                               required="true"/>
                    </td>
                    <td align="right" style="">变更后法人性质：<span style="color:red;">*</span></td>
                    <td colspan="2">
                        <input id="natureNew" name="natureNew" class="nui-textbox" style="width: 100%" allowInput="true"
                               required="true"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="5" style="height: 72px">
                        <input id="natureRemark" name="natureRemark" class="nui-textarea"
                               style="width: 100%;height: 100%" allowInput="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    <td align="right" style="">所在法人单位性质变更 ：<span style="color:red;">*</span></td>
                    <td colspan="3">
                        <input id="unitChange" name="unitChange" class="nui-textbox" style="width: 100%"
                               allowInput="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        <input id="unitOld" name="unitOld" class="nui-textbox" style="width: 100%" allowInput="true"
                               required="true"/>
                    </td>
                    <td align="right" style="">变更后法人单位性质：<span style="color:red;">*</span></td>
                    <td colspan="2">
                        <input id="unitNew" name="unitNew" class="nui-textbox" style="width: 100%" allowInput="true"
                               required="true"/>
                    </td>
                </tr>
                <tr>
                    <td align="right" style="">备注：<span style="color:red;">*</span></td>
                    <td colspan="5" style="height: 72px">
                        <input id="unitRemark" name="unitRemark" class="nui-textarea" style="width: 100%;height: 100%"
                               allowInput="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="unitNameChange" name="unitNameChange" class="nui-textbox" style="width: 100%"
                               allowInput="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="unitNameOld" name="unitNameOld" class="nui-textbox" style="width: 100%"
                               allowInput="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="unitNameNew" name="unitNameNew" class="nui-textbox" style="width: 100%"
                               allowInput="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    <td align="right" style="">备注：<span style="color:red;">*</span></td>
                    <td colspan="5" style="height: 72px">
                        <input id="nuitNameRemark" name="nuitNameRemark" class="nui-textarea"
                               style="width: 100%;height: 100%" allowInput="true" required="true"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        <input id="lxrTel" name="lxrTel" class="nui-textbox" style="width: 100%" allowInput="true"
                               required="true"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="address" name="address" class="nui-textbox" style="width: 100%" allowInput="true"
                               required="true"/>
                    </td>
