    ...
    <fieldset style="border: solid 1px #aaa; padding: 3px; width:95%;">
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <input id="addressNew" name="addressNew" class="nui-textbox" style="width:100%" allowInput="true"
                           required="true"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input id="addressChangeReason" name="addressChangeReason" class="nui-textarea"
