...
<form id="form1" target="id_iframe" style="padding-top:5px;margin:0 auto; border:1px;width: 95%">
        ...
        <div style="margin:auto; padding:5px;">
            <table style="margin: auto;padding-right: 8%" align="center" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <input id="principal" name="principal" class="nui-textbox" width="180px" required="true"
                               EmptyText="请输入负责人"/>
                    </td>
                    <td align="right">负责人电话：<span style="color:red;">*</span></td>
                    <td>
                        <input id="phone" name="phone" class="nui-textbox" width="180px" required="true"
                               EmptyText="请输入负责人电话" onvalidation="onPhoneValidation"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input id="shxydm" name="shxydm" class="nui-textbox" width="180px" EmptyText="请输入社会信用代码"
                               required="true" onvalidation="checkValue"/>
                    </td>
                    <td align="right">住所：<span style="color:red;">*</span></td>
                    <td>
                        <input id="registerAdress" name="registerAdress" class="nui-textbox" width="180px"
                               required="true" EmptyText="请输入住所"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input id="contactPerson" name="contactPerson" class="nui-textbox" width="180px" required="true"
                               EmptyText="请输入联络人"/>
                    </td>
                    <td align="right"> 联络人职位：<span style="color:red;">*</span></td>
                    <td>
                        <input id="contactPosition" name="contactPosition" class="nui-textbox" width="180px"
                               required="true" EmptyText="请输入联络人职位"/>
                    </td>
                </tr>
                <tr>
                    <td align="right">联络人固定电话：<span style="color:red;">*</span></td>
                    <td>
                        <input id="contactTelephone" name="contactTelephone" class="nui-textbox" width="180px"
                               required="true" onvalidation="onPhoneValidation"/>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input id="cmaPermitEffectiveDate" name="cmaPermitEffectiveDate" class="nui-datepicker"
                               style="width: 180px" required="true" EmptyText="请选择日期" allowInput="false"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input id="state" name="state" class="nui-combobox" emptytext="请选择..." valueField="id"
                               width="180" required="true"
                ...
                <tr>
                    ...
                    <td>
                        <input name="areaId" id="areaId" style="width: 180px;" class="nui-buttonedit"
                               onbuttonclick="areaClick" required="true"/>
                    </td>
                    <td align="right">
                        上报机关：<span style="color:red;">*</span>
                    </td>
                    <td>
                        <input name="checkAreaId" id="checkAreaId" style="width: 180px;" class="nui-buttonedit"
                               onbuttonclick="areaClick" required="true"/>
                    </td>
                </tr>
            </table>
    ...
    <div>
        <a id="saveFmxx" class="nui-button" iconCls="icon-save" onclick="saveFmxx()"
           style="margin-left: 47%;margin-top:20px">保存</a>
    </div>
</form>
