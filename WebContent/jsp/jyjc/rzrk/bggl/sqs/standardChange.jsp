    ...
    <fieldset style="border: solid 1px #aaa; padding: 3px; width:95%;">
        <table style="width:100%;">
            <tr>
                ...
                <td>
                    <input id="applyDate" name="applyDate" class="nui-datepicker" required="true" EmptyText="请选择日期"
                           allowInput="false" required="true" width="50%"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td height="52px">
                    <input id="fzrReviewOpinion" name="fzrReviewOpinion" class="nui-textarea"
                           style="width: 100%;height: 100%" required="true"/>
                </td>
                <td align="right" style="">日期：<span style="color:red;">*</span></td>
                <td>
                    <input width="50%" id="fzrReviewOpinionDate" name="fzrReviewOpinionDate" class="nui-datepicker"
            ...
            <tr>
                ...
                <td height="52px">
                    <input id="zjReviewOpinion" name="zjReviewOpinion" class="nui-textarea"
                           style="width: 100%;height: 100%" required="true"/>
                </td>
                <td align="right" style="">日期：<span style="color:red;">*</span></td>
                <td>
            ...
            <div property="columns">
                ...
                <div field="" align="center" headeralign="center" width="200">
                    ...
                    <div property="columns" align="center">
                        <div field="CATEGORY" name="CATEGORY" width="50" headeralign="center" allowsort="true"
                             align="center">
                            (产品/项目/参数)
                        </div>
                    </div>
                ...
                <div field="" align="center" headeralign="center">
                    已批准的标准（方法）
                    <div property="columns" align="center">
                        <div field="STANDARDNAMEANDNUMOLD" name="STANDARDNAMEANDNUMOLD" headeralign="center"
                ...
                <div field="" align="center" headeralign="center">
                    变更后的标准（方法）
                    <div property="columns" align="center">
                        <div field="STANDARDNAMEANDNUMNEW" name="STANDARDNAMEANDNUMNEW" headeralign="center"
                             allowsort="true" align="center">
                            名称、 编号（含年号）
                        </div>
                    </div>
