            ...
            <table style="margin-left: 12%">
                ...
                <tr>
                    ...
                    <td style="height: 70px" colspan="5">
                        <input id="nameChangeReason" name="nameChangeReason" class="nui-textarea"
                ...
                <tr>
                    ...
                    <td>
                        <input id="email" name="email" class="nui-textbox" allowInput="true" required="true"
                               width="100%"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td height="52px" colspan="3">
                        <input id="superiorDeptOpinion" name="superiorDeptOpinion" class="nui-textarea"
