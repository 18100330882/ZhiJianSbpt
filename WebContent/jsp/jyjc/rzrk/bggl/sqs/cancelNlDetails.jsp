        ...
        <div style="width:100%;">
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <input id="productSortNum" name="productSortNum" class="nui-textbox" style="width:50%"
                               required="true"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="productName" name="productName" class="nui-textbox" style="width:90%"
                ...
                <tr>
                    ...
                    <td>
                        <input id="standardNameAndNum" name="standardNameAndNum" class="nui-textarea"
                ...
                <tr>
                    ...
                    <td>
                        <input id="laboratoryPlace" name="laboratoryPlace" class="nui-textbox" style="width: 90%"
                               allowInput="true" required="true"/>
                    </td>
                </tr>
            </table>
