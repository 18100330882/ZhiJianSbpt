    ...
    <fieldset style="width:90%;height: 60%;">
        ...
        <table border="0">
            <tr>
                ...
                <td>
                    <div id="rblsex" name="sex" class="nui-radiobuttonlist" repeatItems="2" repeatLayout="table"
                         repeatDirection="horizontal" textField="text" valueField="id" value="男">
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input id="idCard" name="idCard" class="nui-textbox" width="180px" required="true"
                           onvalidation="onCardNoValidation"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input id="technicalFieldYear" name="technicalFieldYear" class="nui-textbox" width="180px"
                           required="true" EmptyText="请输入年限(数字)" vtype="float"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="4">
                    <input id="address" name="address" class="nui-combobox" emptytext="请选择..." style="width:100%"
                           valueField="SITEADDRESS" required="true" dataField="data" textField="SITEADDRESS"/>
                </td>
            </tr>
        </table>
        <div>
