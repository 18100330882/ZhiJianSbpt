    ...
    <div style="margin:auto; padding:5px;">
        <table style="margin: auto" align="center" border="0" width="100%">
            ...
            <tr height="40px">
                ...
                <td>
                    <input name="sqrq" id="sqrq" class="nui-datepicker" style="width: 232px" EmptyText="请选择申请日期"
                           allowInput="false" required="true"/>
                    希望评审时间：
                    <input name="xwpsrq" id="xwpsrq" class="nui-datepicker" style="width: 246px" EmptyText="请选择希望评审日期"
                           allowInput="false" required="true"/>
                </td>
            </tr>
            <tr height="40px">
                ...
                <td colspan=4>
                    <input name="shxydm" id="shxydm" class="nui-textbox" style="width: 600px" allowInput="true"
                           onvalidation="checkValue" EmptyText="请输入18位社会信用代码" required="true"/>
                </td>
            </tr>
            <tr height="40px">
                <td align="right" colspan=4>
                ...
                <td>
                    <input name="areaId" id="areaId" style="width: 232px;" class="nui-buttonedit"
                           onbuttonclick="areaClick" required="true"/>
                    上报机关：<span style="color:red;">*</span>
                    <input name="checkAreaId" id="checkAreaId" style="width: 232px;" class="nui-buttonedit"
                           onbuttonclick="areaClick" required="true"/>
                </td>
            </tr>
            <tr height="40px">
                ...
                <td colspan=4>
                    <div id="isFirstOrOther" name="isFirstOrOther" class="nui-radiobuttonlist" repeatItems="2"
                         repeatLayout="table" repeatDirection="horizontal" textField="text" valueField="id"></div>
                </td>
            </tr>
        </table>
