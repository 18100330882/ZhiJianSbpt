...
<form id="form1" target="id_iframe" style="padding-top:5px;margin:0 auto; width:840px; border:1px;">
    ...
    <table border="0">
        <tr>
            ...
            <td colspan="3">
                <input id="allNumber" name="allNumber" type="number" class="nui-textbox" width="547px" required="true"
                       EmptyText="此项无需填写.." readonly="readonly"/>
            </td>
        </tr>
        <tr>
            <td align="right">高级专业技术职称（名）：<span style="color:red;">*</span></td>
            <td>
                <input id="hJobTitleNumber" name="hJobTitleNumber" class="nui-textbox" width="180px" required="true"
                       onvaluechanged="valueChangeEvent()" vtype="int" EmptyText="请输入正整数.."/>
            </td>
            <td align="right">占总人数比例（%）：</td>
            <td>
                <input id="hRatioAll" name="hRatioAll" class="nui-textbox" width="180px" required="true"
                       EmptyText="此项无需填写.." readonly="readonly"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input id="mJobTitleNumber" name="mJobTitleNumber" class="nui-textbox" width="180px" required="true"
                       onvaluechanged="valueChangeEvent()" vtype="int" EmptyText="请输入正整数.."/>
            </td>
            <td align="right">占总人数比例（%）：</td>
            <td>
                <input id="mRatioAll" name="mRatioAll" class="nui-textbox" width="180px" required="true"
                       EmptyText="此项无需填写.." readonly="readonly"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input id="pJobTitleNumber" name="pJobTitleNumber" class="nui-textbox" width="180px" required="true"
                       onvaluechanged="valueChangeEvent()" vtype="int" EmptyText="请输入正整数.."/>
            </td>
            <td align="right">占总人数比例（%）：</td>
            <td>
                <input id="pRatioAll" name="pRatioAll" class="nui-textbox" width="180px" required="true"
                       EmptyText="此项无需填写.." readonly="readonly"/>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input id="otherNumber" name="otherNumber" class="nui-textbox" width="180px" required="true"
                       onvaluechanged="valueChangeEvent()" vtype="int" EmptyText="请输入正整数.."/>
            </td>
            <td align="right">占总人数比例（%）：</td>
            <td>
                <input id="oRatioAll" name="oRatioAll" class="nui-textbox" width="180px" required="true"
                       EmptyText="此项无需填写.." readonly="readonly"/>
            </td>
        ...
        <tr>
            ...
            <td>
                <input id="propertyRights" name="propertyRights" class="nui-combobox" style="width:180px"
                       valueField="text" required="true" dataField="data" textField="text" required="true"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                <input id="institutionsArea" name="institutionsArea" class="nui-textbox" width="547px" required="true"
                       EmptyText="此项无需填写.." readonly="readonly"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input id="siteArea" name="siteArea" class="nui-textbox" width="180px" required="true"
                       onvaluechanged="valueChangeEvent2()" vtype="float" EmptyText="请输入数字.."/>
            </td>
            <td align="right">温恒面积（㎡）：<span style="color:red;">*</span></td>
            <td>
                <input id="whArea" name="whArea" class="nui-textbox" width="180px" required="true"
                       onvaluechanged="valueChangeEvent2()" vtype="float" EmptyText="请输入数字.."/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <input id="outdoorsiteArea" name="outdoorsiteArea" class="nui-textbox" width="547px" required="true"
                       onvaluechanged="valueChangeEvent2()" vtype="float" EmptyText="请输入数字.."/>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input id="sitePropertyRights" name="sitePropertyRights" class="nui-combobox" style="width:180px"
                       valueField="text" required="true" dataField="data" textField="text" required="true"/>
            </td>
    ...
    <div>
        <fieldset style="border: solid 1px #aaa; padding: 3px;width:93%;">
            ...
            <div id="dataGridAddress" class="nui-datagrid" style="width:100%;height:120px;" multiSelect="true"
                 idField="sqsId" showPager="false">
