...
<!--
- Author(s): zws
- CreateTime: 2020年6月17日 星期三
- Copyright: Copyright (c) 2020
- Company: 北京永杰友信科技有限公司
- Version：1.0
- Description: 实验室检验检测资质认定(机构资源)
-->
<body>
    ...
    <fieldset style="width:90%;height: 60%;">
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td>
                    <input id="address" name="address" class="nui-combobox" emptytext="请选择..." style="width:180px"
