    ...
    <fieldset style="width:97%;height: 60%;">
        ...
        <table border="0">
            <tr>
                ...
                <td colspan="3">
                    <input id="organizationName" name="organizationName" class="nui-textbox" width="557px"
                           required="true"/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <input id="organizationAddress" name="organizationAddress" class="nui-textbox" width="557px"
                           required="true"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input id="shxydm" name="shxydm" class="nui-textbox" width="200px" required="true"
            ...
            <tr>
                ...
                <td>
                    <input name="startDate" class="nui-datepicker" style="width: 202px" required="true"
                           allowInput="false"/>
                </td>
                <td align="right">有效日期：<span style="color:red;">*</span></td>
                <td>
                    <input name="endDate" class="nui-datepicker" style="width: 202px" required="true"
                           allowInput="false"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input id="contactsPhone" name="contactsPhone" class="nui-textbox" width="200px" required="true"
            ...
            <tr>
                ...
                <td>
                    <input name="unitPhone" class="nui-textbox" width="200px" required="true"
                           onvalidation="onPhoneValidation"/>
                </td>
            </tr>
            <tr>
