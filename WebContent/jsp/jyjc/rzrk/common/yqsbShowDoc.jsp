...
<%
    ...
    String saveFilePageParam = "?action=yqsbsaveword&flowId=" + psbgEntity.getFlowId() + "&filePath=" + filePath + "&psbgId=" + psbgId;
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.ajax({
            url: "<%=basePath%>common_fileSaveNew.action<%=saveFilePageParam%>",
            type: "post",
