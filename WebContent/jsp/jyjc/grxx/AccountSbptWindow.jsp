            ...
            <div>
                <table id="reg_table1">
                    <tr>
                        ...
                        <td style="width: 75%;">
                            <div id="rbl" name="flag" class="nui-radiobuttonlist" valueField="id" repeatItems="0"
                                 textField="text"
                    ...
                    <tr id="eIsDlfr">
                        ...
                        <td style="width:200px;">
                            <input class="nui-radiobuttonlist" id="isDlfr" name="isDlf" required="true" textField="text"
                                   valueField="id" value="0"
                                   data="[{'id':'0','text':'独立法人'},{'id':'1','text':'非独立法人'}]"/>
                        </td>
                    </tr>
                    <tr>
                        <td id="zzjg" class="btxt1" style="width: 230px"><span class="red">*</span><span class="fdlfr">所属法人</span>统一社会信用代码：
                        </td>
                        <td id="sfz" class="btxt1"><span class="red">*</span>身份证号：</td>
                        <td style="width:200px;">
                            <input id="zzjg2" name="zzjgdm" style="width: 260px" onvalidation="checkValue"
                                   class="nui-textbox"/>&nbsp;&nbsp;&nbsp;<span id="z1"
                                                                                class="reg_tips">请填写统一社会信用代码。</span>
                    ...
                    <tr>
                        ...
                        <td style="width:800px;">
                            <input id="sqr" name="qymc" style="width: 260px" class="nui-textbox"
                                   onvalidation="checkEnterName" required="true"/>&nbsp;&nbsp;
                            <span id="nametips" class="reg_tips">请填写营业执照上的企业名称。</span><span id="nameError"
                                                                                            style="color:#CC0000"></span>
                            <span id="nametips1" class="reg_tips">请填写个人姓名。</span><span id="nameError"
                                                                                       style="color:#CC0000"></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:200px;">
                            <input name="lxr" style="width: 260px" class="nui-textbox" required="true"/>&nbsp;&nbsp;&nbsp;<span
                                class="reg_tips">请填写联系人姓名。</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:200px;">
                            <input id="lxdh" name="lxdh" style="width: 260px" class="nui-textbox"
                                   onvalidation="onPhoneOnvalidation" required="true"/>&nbsp;&nbsp;&nbsp;<span
                                class="reg_tips">请填写联系电话。</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="btxt1"><span class="red">*</span><span class="qyClass">注册</span><span
                                class="grClass">通信</span>地址：
                        </td>
                        <td style="width:200px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="sfbs" name="sfbs" class="nui-combobox" style="width:250px;" textField="text"
                                   valueField="id" required="true"
                                   allowInput="true" data="[{'id':'0','text':'是'},{'id':'1','text':'否'}]" value="0"
                                   onvaluechanged="sfbsChange"
                                   enabled="true"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:200px;">
                            <input id="area" name="areaId" style="width: 260px" class="nui-buttonedit"
                                   onbuttonclick="onButtonEdit" required="true"/>
                            <input id="wsXzqh" name="wsXzqh" style="width: 260px; display: none;"
                                   emptyText="格式： XX省XX市XX县(区)" class="nui-textbox"
                                   onbuttonclick="onButtonEdit" required="true"/>&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td id="frdh" class="btxt1"><span class="red">*</span><span class="fdlfr">所属法人</span>法定代表人电话:
                        </td>
                        ...
                        <td style="width:200px;">
                            <input id="frdh2" name="fddbrdh" style="width: 260px" class="nui-textbox"
                                   ...
                                   required="true"/>&nbsp;&nbsp;&nbsp;<span id="z3"
                                                                            class="reg_tips">请填写（所属法人）法定代表人电话。</span>
                    ...
                    <tr>
                        ...
                        <td style="width:200px;">
                            <input name="yzbm" style="width: 260px" class="nui-textbox"
