...
<div style="height:350px;">
    ...
    <div class="nui-fit">
        <ul id="tree1" class="nui-tree" url="<%=basePath %>area_treeForRegist.action?isEnabled=0" style="width:100%;"
            onnodeclick="onNodeDblClick"
            expandOnLoad=0 sortField="PAIXU" showTreeIcon="true" textField="AREANAME" idField="ID"
