 ...
 * @Version 1.0
 */
@Repository(PersonChangeDetailsDao.SERVICE_NAME)
public class PersonChangeDetailsDaoImpl extends BaseDaoImpl<PersonChangeDetails> implements PersonChangeDetailsDao {
    @Override
    public Map<String, Object> queryListBySerialNum(Map<String, Object> reqMap) {
        ...
        sql.append("SELECT * FROM PERSONCHANGEDETAILS where 1=1 ");
    ...
    public void deleteBySerialNum(String serialNumber) {
        ...
        deleteSql.append("DELETE FROM PERSONCHANGEDETAILS JJ");
